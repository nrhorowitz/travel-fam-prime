...
class ReplyBox extends Component {
    ...
    render() {
        if (this.state.visible) {
            return (
                <div style={postBox}>
                    <TextField id={this.props.id} style={postArea} label="CREATE POST" rows="5" multiline></TextField>
                    ...
                    <Button style={postButton} variant="contained" color="secondary" onClick={() => {
                        ...
                        this.props.writeToDatabase(input, this.props.id);
                        document.getElementById(this.props.id).value="";
                        this.props.toggleReplyBoxVisible(this.props.id);
                    }}>
